...
bool         configHandheldLowres                 = false; // render 3D world through the low-res upscale FBO
#endif
// sound settings
...
static const struct ConfigOption options[] = {
    ...
    {.name = "handheld_lowres",                .type = CONFIG_TYPE_BOOL, .boolValue = &configHandheldLowres},
#endif
    // sound settings
